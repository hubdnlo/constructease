...
public class EstoqueArquivoRepository {
    ...
    private static final Logger logger = LoggerFactory.getLogger(EstoqueArquivoRepository.class);

    private final Resource estoqueJson;

    @Autowired
    public EstoqueArquivoRepository(@Value("${estoque.repository.path}") Resource resource) {
